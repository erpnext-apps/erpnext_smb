...
def validate_custom_fields(doc, method):
	...
	if plan == "Basic" and count >= 100:
		frappe.throw(_("Only 100 custom fields are allowed as per your plan"))
...
def validate_user_limit(doc, method):
	...
	if plan == "Basic" and count >= 5:
		frappe.throw(_("Only 10 users are allowed as per your plan"))
	elif plan == "Essential" and count > 25:
		frappe.throw(_("Only 25 users are allowed as per your plan"))
	elif plan == "Professional" and count > 50:
		frappe.throw(_("Only 50 users are allowed as per your plan"))
...
def validate_company(doc, method):
	...
	if plan == "Basic" and count >= 1:
		frappe.throw(_("Only one company allowed as per your plan"))
	elif plan == "Essential" and count >= 2:
		frappe.throw(_("Only 2 companies are allowed as per your plan"))
	elif plan == "Professional" and count >= 5:
		frappe.throw(_("Only 5 companies are allowed as per your plan"))
...
def validate_custom_doctypes(doc, method):
	...
	if plan == "Basic" and count >= 0:
		frappe.throw(_("No custom forms allowed as per your plan"))
	elif plan == "Essential" and count >= 10:
		frappe.throw(_("Only 5 custom forms are allowed as per your plan"))
...
def validate_client_scripts(doc, method):
	...
	if plan == "Basic" and count >= 0:
		frappe.throw(_("No client scripts allowed as per your plan"))
	elif plan == "Essential" and count >= 5:
		frappe.throw(_("Only 10 client scripts are allowed as per your plan"))
...
def validate_server_scripts(doc, method):
	...
	if plan == "Basic" and count >= 0:
		frappe.throw(_("No server scripts allowed as per your plan"))
	elif plan == "Essential" and count >= 5:
		frappe.throw(_("Only 10 server scripts are allowed as per your plan"))
